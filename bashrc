...
#alias ll='ls -ahlFv --group-directories-first'
alias la='ls -lh'
alias l='ls -CF'
# exa alias
...
# add new PATH items for zotero
PATH=$PATH:/opt/zotero/Zotero_linux-x86_64/
export PATH
...
# alias for snuffler due to theme complications
alias snuffler="QT_STYLE_OVERRIDE=fusion snuffler"
